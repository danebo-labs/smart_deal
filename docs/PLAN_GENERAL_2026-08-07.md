...
8. **Actualización del 11 de agosto:** Gonzalo respondió al mensaje de calibración del lunes 10. Compromiso operativo escrito (biblioteca de manuales en camino, un par de ingenieros para probar, Danebo carga el software, almuerzo a la vuelta). Archivos aún no enviados; pregunta de margen sin respuesta. Detalle y lectura en [Plan de Agosto](PLAN_AGOSTO_2026-08-07.md), sección 3.2.3.
...
**Calendario.** El precio se decide internamente en septiembre, sobre costo medido y sobre las respuestas de mercado ya recibidas más las que dé Gonzalo, para tener cifra lista al cerrar el piloto de octubre. Gonzalo ayuda a **calibrar**, respondiendo preguntas de volumen y de facturación del rubro; no participa de la decisión ni conoce el número. **Nota del 11 de agosto:** la primera respuesta de campo no vino de él sino de un contacto sin nada en juego, y esa es la fuente que hay que privilegiar para calibración — quien evalúa un rol comercial en el negocio tiene incentivo para sombrear, un informante neutral no.

**Qué habilita y qué no habilita el dato del 11 de agosto, porque de esto depende que la decisión de septiembre sea sólida y no un supuesto con mejor redacción.** Habilita: fijar el precio por equipo con una banda de ratio de campo (60–84 equipos por técnico) en vez de con dos supuestos propios en tensión, y dimensionar el ticket del primer cliente sobre una cartera observada de 100–150 equipos. No habilita: **citar esas cifras como dato de mercado ante terceros.** Vienen de un solo informante, por un canal informal, y el ratio es una **derivación aritmética de su rutina diaria**, no un ratio que él haya reportado. La confirmación con Abel o Jesús pasó de bloqueante a deseable, y sigue siendo lo que convertiría la banda en rango citable en una postulación a fondos.
...
**Señal nueva del 11 de agosto (mensaje de respuesta):** reconfirmó por escrito que está armando la biblioteca de manuales ("me van a pasar todo"), ofreció la app a un par de ingenieros para que saquen conclusiones, pidió que Danebo cargue el software, y confirmó el almuerzo a la vuelta. Eso mueve el track de "entusiasmo de demo" a "compromiso operativo escrito". Lo que **aún no** ocurrió —y es el tripwire que importa— es el envío de los archivos.

El dilema se disuelve al separar dos cosas que se están confundiendo en una sola:

| | ¿Se puede confiar? | Por qué |
|---|---|---|
| **Participación operativa**: acceso a ingenieros/técnicos, manuales de su red, criterio de mercado en conversación | **Sí** | Confirmado por escrito el 11 ago (manuales + ingenieros + almuerzo). Falta el envío de archivos. Si se cae, se pierden semanas, no la empresa |
...
| Fecha | Observación | Estado / qué significa si no ocurre |
|---|---|---|
| **Primera semana de viaje** | ¿Llegan los manuales que prometió? | **Abierta.** Compromiso escrito el 11 ago; falta el archivo. Es la observación clave, y es mejor señal que un café: una reunión puede fallar por agenda, un enlace de Drive no. Un compromiso concreto incumplido tras un recordatorio suave es información de primer orden |
| **Durante el viaje** | ¿Sus ingenieros/técnicos usan el sistema de forma voluntaria? | **Condicionada** a que lleguen los manuales y Danebo dé el visto bueno (secuencia que él fijó). Se mide en `bedrock_daily_costs`, sin preguntarle. Si él no logra que su propio equipo lo pruebe, tampoco va a lograr que un cliente lo compre |
| **Antes del 3 de septiembre** | ¿Confirma fecha concreta del almuerzo? | **Parcialmente cerrada:** el 11 ago confirmó el almuerzo a la vuelta; falta día/hora en calendario (proponer mar 8 / mié 9 sep). Una fecha que se posterga dos veces es un no que todavía no se dice |
...
**Nota deliberada: el café del 10 de agosto no está en esta tabla.** No ocurrió y no es señal de nada — la agenda de un ejecutivo comercial un lunes cualquiera no dice nada sobre su interés. El mensaje asincrónico del lunes 10 sí se envió y sí produjo respuesta operativa. El primer acercamiento presencial ya ocurrió el 6 de agosto; la conversación que sí exige presencia es el almuerzo de septiembre. Ver [Plan de Agosto](PLAN_AGOSTO_2026-08-07.md), sección 3.2.3.
...
|---|---|---|
| Agosto, durante el viaje | Se recogen las dos primeras señales del tripwire: **manuales (aún pendientes de envío al 11 ago)** y uso voluntario de sus ingenieros tras el visto bueno de Danebo | No se conversa estructura |
| **Almuerzo de septiembre** | **Se hacen las preguntas** de la sección 9.3: aporte concreto, dedicación, capital o trabajo, exclusividad, conocimiento del empleador, vesting y cliff. También la pregunta de margen que no respondió por mensaje | **No se decide ni se compromete nada.** Es una conversación de levantamiento, no de cierre |
...
1. **Idioma español por defecto** antes de entregar acceso a los ingenieros/técnicos de Gonzalo. Bloqueante: en la demo del 6 de agosto la lectura de consola salió en inglés y él lo notó. Los manuales pueden llegar cualquier día del viaje y el acceso hay que poder entregarlo en ese momento.
2. **Conseguir los manuales de Gonzalo**, por el canal que sea. El entregable es el archivo, no la reunión. **Estado al 11 ago:** compromiso escrito, envío pendiente. Track asincrónico con toque semanal durante el viaje ([Plan de Agosto](PLAN_AGOSTO_2026-08-07.md), sección 3.8).
3. **Cerrar día/hora del almuerzo estratégico de septiembre.** Él ya confirmó el almuerzo a la vuelta (11 ago); falta anclar martes 8 o miércoles 9 de septiembre en el calendario.
...
19. ~~**Segundo toque de incidencia a la fuente neutral**~~ → **ejecutado y respondido el 11 de agosto, y se gastó en el ratio y no en la incidencia** porque Abel y Jesús seguían en silencio y el ratio era lo único que bloqueaba el precio de septiembre. Resultado: 3–4 mantenciones diarias, cartera de mediana de 100–150 equipos, banda derivada de 60–84 equipos por técnico ([Plan de Agosto](PLAN_AGOSTO_2026-08-07.md), sección 3.3.4). **El presupuesto de toques con esa fuente queda en cero.** Lo que sigue abierto —incidencia de fallas y vueltas por falla— **queda sin fuente asignada**: se retoma con Abel o Jesús si responden, o se mide en el piloto de octubre en vez de preguntarlo. No se deduce.
20. **Reescribir el encuadre de valor del pitch** antes de la primera cotización, ahora con dos piezas y no una: participación sobre ingreso total por equipo y protección del centro de utilidad —correctivos y revisitas no facturadas— en lugar de ahorro de horas y en lugar del margen de la mantención; **y el eje de la mano de obra barata**, que es hacer rendir al técnico que el cliente ya contrató en vez de ahorrarle minutos a un experto (sección 5). Es texto, no código, y va antes del piloto de octubre porque es lo que se dice en la reunión de cierre.
21. **Cerrar el modelo de dotación del cliente antes de cotizar:** si el "saca fallas" es una persona distinta del técnico de ruta o el mismo en modo reactivo. El modelo del "técnico universal" existió y la fuente de campo declara no saber si sigue vigente, así que **queda abierto y no se resuelve por deducción**. Decide sobre cuántos usuarios se cuenta el ratio, o sea el precio. Va a Abel o Jesús, que administran nómina ([Plan de Agosto](PLAN_AGOSTO_2026-08-07.md), sección 3.3.4).

### P2 — con tiempo sobrante

22. **Cruce de cartolas** para confirmar la caja base de julio y los extraordinarios (sección 6.2). Bajó de P1: la brecha que motivaba la urgencia era un error de cálculo y ya está explicada.
23. **Batch de UX móvil:** división vertical de la pantalla priorizando la imagen sobre los checkboxes, botón de envío que no dispare con Enter en móvil, y mensaje de progreso cuando el procesamiento de un archivo pasa los 20 segundos.
24. **Prueba comparativa reproducible** contra ChatGPT con el mismo manual cargado, documentando los cuatro pilares de la sección 13.
...
|---|---|---|
| Primer contrato pagado | Noviembre 2026 | Una mantenedora **mediana** convierte desde el piloto de octubre. A **100–150 equipos** (dato de campo del 11 de agosto, que reemplaza la estimación de 40–100 y el supuesto original de 300–600, ver [PRICING_Y_MERCADO_2026-08-07.md](PRICING_Y_MERCADO_2026-08-07.md), sección 3.1): **CLP 100.000–150.000/mes** |
| Danebo cubre su propio COGS | Diciembre 2026 | Base combinada superior a ~850 equipos: USD 895/mes contra COGS de USD 416, margen bruto 53%. Con clientes de 100–150 equipos son **6 a 8 mantenedoras** (antes 9 a 14) — el objetivo sigue siendo la mediana o mediana-grande, no cualquier logo. **El supuesto de 30 usuarios queda validado en campo:** a 60–84 equipos por técnico, 850 equipos son del orden de 10–14 técnicos de ruta más supervisores y saca fallas |
...
El criterio de diciembre está expresado como base de equipos y no como "dos clientes", porque dos clientes chicos no alcanzan el margen y dos medianos lo superan con holgura. **La cifra a vigilar es la base de equipos, no el conteo de logos.** La serie de correcciones del tamaño de cliente esperado —300–600 supuesto, 40–100 razonado, **100–150 con dato de campo**— deja el número de logos necesarios muy por encima del plan original, y es la razón de más peso para que la red de Gonzalo —que puede abrir puertas a clientes mediano-grandes en vez de solo microempresas— importe tanto como se plantea en la sección 9. Lo que cambió el 11 de agosto es que el objetivo de diciembre pasa de 9–14 logos a 6–8, que es la diferencia entre inalcanzable y difícil.
...
| **Ratio equipos/técnico desconocido.** Es la variable que decide si el modelo por equipo supera el piso de costo | **Degradado el 11 de agosto: hay banda de trabajo de 60–84 equipos por técnico**, derivada de una rutina de campo de 3–4 mantenciones diarias, y cae en la zona donde CLP 1.000 por equipo supera 70% de margen. **Sigue siendo riesgo por tres motivos:** es derivación y no ratio reportado, viene de una sola fuente, y no descuenta la capacidad que consume la atención de fallas por proximidad | Confirmación con Abel o Jesús (Plan de Agosto, secciones 3.4 y 3.5), contraste en el almuerzo, y medición directa en el piloto de octubre |
| **Riesgo de método: concluir sobre supuestos.** El caso concreto es la afirmación heredada de que la fuente de campo trabaja con varias mantenedoras, que es la premisa que le da peso a su lectura del ratio | **Marcada como heredada y no verificada en los cuatro documentos.** El test de verificación se incrustó en la pregunta de tamaño de cartera y **volvió inconcluso**: respondió sobre el segmento en general, con especulación declarada en el extremo grande | Regla fija de la sección 0. Mientras no se verifique, la banda del ratio decide precio internamente y no se cita como dato de mercado |
| **El ahorro de tiempo no financia el precio** | Identificado y cuantificado. **Mitigación nueva del 11 de agosto:** argumento de revisita no facturada y protección del centro de utilidad, sección 5 | Encuadre de participación en ingresos, sección 5; medición del piloto de octubre |
| **El margen de la mantención es más delgado de lo que suponía el modelo.** Dato de campo del 11 de agosto: la tarifa mensual cubre nómina, visitas por falla ilimitadas y guardia 24/7; la utilidad vive en correctivos, repuestos y modernizaciones | El supuesto de CLP 40.000 de margen por equipo queda marcado como cota superior, no como dato. No cambia el piso de precio —que sale del COGS medido— sino el argumento de venta y la tabla de resistencia. **Matizado por la propia fuente:** la mantención sí es rentable, pero no lo sería sin las reparaciones, y su función es retener al cliente | [PRICING_Y_MERCADO_2026-08-07.md](PRICING_Y_MERCADO_2026-08-07.md), secciones 4.2, 4.3 y 9.1. Cierre con la proporción correctivo/mantención en el almuerzo; **la incidencia de fallas quedó sin fuente asignada** (sección 12, P1) |
| **Usuario primario con menos conocimiento del que el producto asumía.** Dato de campo del 11 de agosto: el técnico de mantención es hoy el eslabón que menos sabe, porque el empleador contrata mano de obra barata | **Es oportunidad comercial y restricción de producto a la vez.** Comercialmente valida al usuario objetivo y reencuadra el pitch (sección 5). Como riesgo: un usuario con menos base detecta peor una respuesta incorrecta, así que sube la exigencia de evidencia, trazabilidad y resguardo de seguridad | Reglas de seguridad y trazabilidad del repositorio, que no se relajan; batería de generalización (sección 12, P1) y medición del piloto de octubre |
...
| **Corpus.** "No es tan fácil conseguir los manuales de Kone, Otis, Schindler" | Frente de trabajo con fuente identificada: Gonzalo aportará manuales de su red (**compromiso escrito 11 ago; envío pendiente**), y los manuales de fabricante circulan en grupos de técnicos | Fase 1 del piloto se limita a manuales de fabricante, cero datos internos de ninguna empresa |
...
| jueves 31 de diciembre | Gate de runway | ¿Hay base combinada de ~850 equipos (6–8 mantenedoras de 100–150 equipos, o menos si alguna es mediana-grande) o capital no dilutivo en camino? Encuentra 6,2 meses de caja libre más 6 de reserva, así que hay margen para decidir sin apuro. Si no hay ninguno de los dos, el gate de enero es decidir pivote de segmento con los datos de la matriz. **El capital no dilutivo no cuenta como "en camino" hasta que esté adjudicado** (sección 8.1) |
...
|---|---|---|
| Unidad de cobro | Por técnico o por informe, sin dimensionar | Por equipo gestionado y por informe, con TAM y contraste contra el piso de costo. **Confirmado con dato de campo el 11 ago:** el cliente ya factura por equipo y por mes, no por visita |
| Encuadre de valor | Ahorro de tiempo, con participación en ingresos como alternativa | Participación sobre **ingreso total por equipo** (mantención + correctivos + modernizaciones) y protección de la revisita no facturada. El margen de la mantención deja de usarse como denominador: es la línea que el administrador del edificio ya tiene comprimida. **Segundo eje agregado el 11 ago:** hacer rendir a la mano de obra barata que el cliente ya contrató, porque el técnico de ruta es el eslabón de menor conocimiento |
| Tamaño del cliente objetivo | 300–600 equipos, supuesto | **100–150 equipos con dato de campo** (11 ago). El objetivo de diciembre baja de 9–14 logos a 6–8, y el ticket del primer contrato se duplica respecto de la estimación intermedia de 40–100 |
| Ratio equipos/técnico | Dos supuestos propios en tensión (22–44 contra 60–100) | **Banda derivada de campo: 60–84**, que resuelve la tensión a favor del margen de 70%. Marcada como derivación de una sola fuente, no como dato de mercado |
| Disciplina de evidencia | Implícita | **Regla fija:** cada afirmación se marca como dato de campo, derivación, especulación de la fuente o razonamiento propio; lo heredado y no confirmado se rotula como no verificado y no sostiene decisiones de precio |
...
| Gonzalo | Track asesor → socio | Demo ejecutada y por sobre lo esperado; respuesta operativa del 11 ago (manuales + ingenieros + almuerzo, archivos pendientes); asimetría nombrada; tripwire con estado parcial; sin forzar café del 10 ago |
