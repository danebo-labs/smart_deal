...
| [PLAN_COPILOTO_GENERACION_2026-09-22.md](PLAN_COPILOTO_GENERACION_2026-09-22.md) | **A, G, mediciones 2–8, D y CG-D16 cerradas 22-sep.** Medición 8: proyección corta, 4 envíos, US$0,0226. Útil y safety pasan. CG-D16 en (a). El camino local no está desplegado. |
| [PLAN_VALIDACION_CG_D16_2026-09-22.md](PLAN_VALIDACION_CG_D16_2026-09-22.md) | CG-D16 cerrada en (a). La gramática de parada y de lista exhaustiva se queda. Si coinciden, manda la parada. |
