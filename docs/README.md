...
| [PLAN_COPILOTO_GENERACION_2026-09-22.md](PLAN_COPILOTO_GENERACION_2026-09-22.md) | **A, G, mediciones 2–8 y D cerradas 22-sep.** CG-D16 reabierta esa noche: toda respuesta visible va en prosa, también la lista y la parada. CG-D19 abierta, sin implementar. |
| [PLAN_PILOTO_ELEMONT_2026-09-24.md](PLAN_PILOTO_ELEMONT_2026-09-24.md) | **Abierto 23-sep.** Piloto Elemont MH (Jesús, cuenta legacy): diagnóstico I/R/G de la revisión de 12 preguntas, defecto de indexación en la hoja 1, guion con pin, decisiones D1 (parche de chunk), D2 (medición US$0,10), D3 (no desplegar `fc/pr2`). |
| [PLAN_VALIDACION_CG_D16_2026-09-22.md](PLAN_VALIDACION_CG_D16_2026-09-22.md) | Validación de la tarde: recomendó (a). Lahiri la dejó sin efecto esa noche (V40 del plan copiloto). El técnico no ve esos rótulos. |
